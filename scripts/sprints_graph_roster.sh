...
OUTPUT_FOLDER=../tests/runs/graphs_params_stats_roster
MODE='-r'
...
python run.py -rn $RUNS_NUMBER -e $EXECUTABLE_PATH -n $SOLUTION_NUMBER -i 20000 -l 1000 -c 0.5 -p "$SPRINTS_FOLDER/sprint_txt" -o "$OUTPUT_FOLDER/sprint_20000_1000_05/sprint" $MODE
...
python run.py -rn $RUNS_NUMBER -e $EXECUTABLE_PATH -n $SOLUTION_NUMBER -i 40000 -l 1000 -c 0.5 -p "$SPRINTS_FOLDER/sprint_txt" -o "$OUTPUT_FOLDER/sprint_40000_1000_05/sprint" $MODE
...
python run.py -rn $RUNS_NUMBER -e $EXECUTABLE_PATH -n $SOLUTION_NUMBER -i 60000 -l 1000 -c 0.5 -p "$SPRINTS_FOLDER/sprint_txt" -o "$OUTPUT_FOLDER/sprint_60000_1000_05/sprint" $MODE
